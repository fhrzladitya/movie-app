...
function Home({ theme, language, activePage, onNavigate }) {
  ...
  useEffect(() => {
    ...
    // reset visible cards saat pindah page
    setVisibleCards([]);

    // kalau tidak ada card langsung stop
  ...
  }, [activePage, filteredMovies.length]);
  ...
  return (
    ...
    >
      ...
      <div className={compact ? "p-4" : "p-5"}>
        <h2 className="mb-4 line-clamp-1 text-2xl font-bold">
          {movie.name}
        </h2>
