      ...
      {showSearchModal && (
        ...
        >
          <div
            ...
            className={`flex w-[92%] max-w-2xl max-h-[85vh] flex-col rounded-3xl border p-6 shadow-2xl backdrop-blur-2xl transition-transform transition-opacity ${
              isDark
          ...
          >
            ...
            <div className="mt-6 flex-1 overflow-y-auto scrollbar-hide pr-2">
              {search.trim() && (
                <div>
                  <p
              ...
              {recentSearches.length > 0 && (
                <div className={search.trim() ? "mt-5" : ""}>
