  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col gap-3 py-3 md:flex-row md:items-center md:justify-between md:px-1">
          
          {/* LOGO */}
          <button
            type="button"
            onClick={() => onNavigate("home")}
            className="text-left text-2xl font-extrabold tracking-wide bg-gradient-to-r from-red-500 via-orange-400 to-yellow-300 bg-clip-text text-transparent md:text-3xl"
          >
            MovieVerse
          </button>
          ...
          <div className="overflow-x-auto scrollbar-hide">
            ...
            <nav className="flex min-w-max items-center gap-2 text-sm font-semibold">
              ...
              <button
                ...
                className={`flex h-10 w-10 items-center justify-center rounded-full border text-sm font-bold transition md:h-11 md:w-11 ${
                  isDark
              ...
              <button
                ...
                className={`flex h-10 w-10 items-center justify-center rounded-full border text-sm transition md:h-11 md:w-11 ${
                  isDark
                    ? "border-white/15 bg-white/10 hover:bg-white/20"
                    : "border-slate-200 bg-white/80 hover:bg-white"
                }`}
