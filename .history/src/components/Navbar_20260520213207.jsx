...
function Navbar({ theme, language, activePage, onNavigate, onToggleTheme, onToggleLanguage }) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center px-5 py-4 relative">
        <button
          type="button"
        ...
        <div className="absolute right-5 top-4 md:static flex items-center gap-2 text-sm font-semibold">
          <button
            type="button"
        ...
        <nav className="flex flex-wrap items-center gap-2 mt-3 md:mt-0 w-full md:w-auto text-sm font-semibold">
